# -*- coding: utf-8 -*-
import codecs
artists =["Woody Harrelson", "Abigail Breslin", "Amber Heard", "Bill Murray", "Derek Graf"]
...
require_once '../connect.php';
    ...
    if($polaczenie->connect_errno !=0){
      ...
      $mainid =1;
      $artist_name ="ArtistName12";
      $artist_lname ="ArtistLastName12";
      $img_name="emma_stone";
...
END
    ...
    """
    cont = content.replace("emma_stone",str(xx)).replace("ArtistName12",firstName).replace("ArtistLastName12",lastName)
    f.write(cont)
