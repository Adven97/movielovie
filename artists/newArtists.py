...
# artists =["Noah Jupe", "Cade Woodward", "Leon Russom", "Millicent Simmonds","Sumalee Montano","Frank Mottek","Finn Wittrock","Callie Hernandez","Sonoya Mizuno","Jessica Rothe","Josh Pence"]
artists =["Emily Blunt", "John Goodman","Suzanne Cryer","Bradley Cooper","Ryan Gosling","John Legend","Rosemarie DeWitt","J.K. Simmons"]
for x in artists:
...
END
    ...
    """
    cont = content.replace("derek_graf","noname").replace("tttuuu1",firstName).replace("uuuttt",lastName)
    f.write(cont)
